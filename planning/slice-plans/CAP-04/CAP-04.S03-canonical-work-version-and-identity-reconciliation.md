...
- ADR: Work versus WorkVersion model and version taxonomy.
- ADR: Exact auto-link rules and probabilistic candidate thresholds.
- ADR: Reversible merge/split implementation.
...
2. Confirm `CAP-04` is the active capability campaign and `CAP-04.S03` is the next eligible slice.
3. Claim the first READY task in order: `CAP-04.S03.T01`. Do not globally select work outside the capability.
