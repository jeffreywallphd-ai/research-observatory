...
source_sha256: 01f962b9215bd1acf7b0e69a436b3d6df8474630c539fbe0b2c7fcbb856ce2aa
...
| `W1` | `W1.A06` | `ECR-0005` | `planning/wave-amendment-approvals/W1.A06.json` | `APPROVED` | `CHANGES_REQUESTED` | `NONE` | 0 |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `PAUSED` | `PAUSED` | 13/15 | 41/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 5/6 | 15/20 | - |
