...
source_sha256: 3e918bc28ccea0926a206169619ee22db6537564019cc5638ca67761d90ee01b
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 14/15 | 51/51 | `G1` / `PENDING` |
...
| CAP-model-gateway (`CAP-07`) — Provider-neutral model gateway and governed AI execution | `NONE` | `PENDING` | 0/5 | 3/15 | - |
