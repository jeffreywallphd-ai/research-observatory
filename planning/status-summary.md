...
| `CAP-02.S04.T03` | `append-only v1` | 1 | `R02` | changes-requested / nash-independent-reviewer | `CAP-02.S04.T03-R01-F01` |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 7/15 | 24/48 | `G1` / `PENDING` |
