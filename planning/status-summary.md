...
| `CAP-03.S02.T02` | `append-only v1` | 2 | `-` | approved / agent:nash | - |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 1/6 | 5/20 | - |
