...
source_sha256: c64e3620af9acb47d449699903c9b7467b560e7de7333a1741c91f6a4ce07a7e
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 4/15 | 14/48 | `G1` / `PENDING` |
...
| CAP-local-project-storage (`CAP-02`) — Local projects, durable storage, security, and recovery | `NONE` | `PENDING` | 0/5 | 2/16 | `CAP-02.S01.T03` |
