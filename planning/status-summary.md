...
| `CAP-03.S03.T02` | `append-only v1` | 2 | `R03` | changes-requested / codex-independent-provenance-ledger-reviewer | `CAP-03.S03.T02-R02-F01`, `CAP-03.S03.T02-R02-F02` |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 10/15 | 33/48 | `G1` / `PENDING` |
