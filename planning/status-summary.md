...
source_sha256: 4a530f5f391738aafdd3b6e2198ccd0717057bd8fd40eb16717cd5d80f457718
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 4/15 | 13/48 | `G1` / `PENDING` |
...
| CAP-local-project-storage (`CAP-02`) — Local projects, durable storage, security, and recovery | `NONE` | `PENDING` | 0/5 | 1/16 | `CAP-02.S01.T02` |
