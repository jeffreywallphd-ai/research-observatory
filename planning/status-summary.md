...
| `CAP-02.S04.T02` | `append-only v1` | 0 | `R01` | - / - | - |
...
| CAP-local-project-storage (`CAP-02`) — Local projects, durable storage, security, and recovery | `NONE` | `PENDING` | 3/5 | 10/16 | `CAP-02.S04.T02` |
