...
| `W1` | `W1.A05` | `ECR-0004` | `planning/wave-amendment-approvals/W1.A05.json` | `ACTIVE` | `APPROVED` | `ACTIVE` | 4 |
...
| `W1.A05.T03` | `append-only v1` | 1 | `-` | changes-requested / codex-independent-sign-in-policy-security-reviewer | `W1.A05.T03-R01-F01` |
## Wave progress
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 3/6 | 9/20 | `CAP-03.S04.T01` |
...
| `W1.A05.T03` Add versioned application sign-in configuration and safe transitions | `IN_PROGRESS` | codex | `codex/w1-windows-local-runtime` |
