...
| `CAP-07.S01.T01` | `append-only v1` | 1 | `-` | changes-requested / codex-independent | `CAP-07.S01.T01-R01-F01` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 1/6 | 3/20 | - |
