...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 11/15 | 36/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 3/6 | 10/20 | `CAP-03.S04.T02` |
...
|---|---|---|---|
| `CAP-03.S04.T02` Implement the local durable queue and worker supervisor | `IN_PROGRESS` | codex | `codex/w1-windows-local-runtime` |
