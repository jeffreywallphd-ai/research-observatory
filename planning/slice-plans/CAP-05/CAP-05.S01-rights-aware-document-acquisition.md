...
- Binding detail: Local file quarantine and password-protected document policy.
...
2. Confirm W2 is the approved active campaign and `CAP-05.S01` is dependency-eligible.
3. Claim only the next READY task in `CAP-05.S01` through taskctl; do not bypass Wave dependencies or create a capability lease.
