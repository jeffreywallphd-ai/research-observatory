...
- ADR: Import IR and source-key/idempotency algorithm.
- ADR: CSV mapping-profile and formula-injection policy.
...
2. Confirm `CAP-04` is the active capability campaign and `CAP-04.S01` is the next eligible slice.
3. Claim the first READY task in order: `CAP-04.S01.T01`. Do not globally select work outside the capability.
