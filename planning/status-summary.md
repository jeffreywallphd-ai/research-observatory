...
| `CAP-03.S01.T02` | `append-only v1` | 1 | `R02` | changes-requested / nash-independent-domain-lifecycle-reviewer | `CAP-03.S01.T02-R01-F01` |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 8/15 | 26/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 0/6 | 1/20 | `CAP-03.S01.T02` |
