...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 11/15 | 37/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 3/6 | 11/20 | `CAP-03.S04.T03` |
...
|---|---|---|---|
| `CAP-03.S04.T03` Build task center, progress, cancellation, and human-gate UI | `IN_PROGRESS` | codex | `codex/w1-windows-local-runtime` |
