...
const schemaDigest = "8279d14052601f4e0b6ae1a9897076a167d32798be9c97efcb25efbadfd370e4" as const;
export const CORE_API_OPENAPI_SHA256 = schemaDigest;
export const CORE_API_WORKFLOW_PROFILE_PROJECTION_SHA256 = "sha256:2af15314d04358edf8a057ca9b806dc25d3e8f55fef804e48db75f02eca5cd4a" as const;
export const CORE_API_CLIENT_VERSION = "1.0.0" as const;
export type CoreApiOperationId = "accept_intent_projects_intent_acceptances_post" | "archive_project_projects_archive_post" | "available_projects_connectors_capabilities_get" | "begin_review_projects_imports_begin_review_post" | "cancel_operation_runtime_operations__operation_id__cancel_post" | "cancel_preview_projects_imports_cancel_post" | "cancel_projects_connectors_jobs_cancel_post" | "cancel_workflow_job_projects_workflows_jobs__job_id__cancel_post" | "capabilities_runtime_capabilities_get" | "clear_project_cache_projects_privacy_cache_clear_post" | "close_project_projects_close_post" | "command_workflow_progress_projects_workflow_progress_commands_post" | "commit_cancel_projects_imports_commit_cancel_post" | "commit_start_projects_imports_commit_start_post" | "commit_status_projects_imports_commit_status_post" | "compare_recalculation_projects_recalculation_comparisons_post" | "configuration_runtime_configuration_get" | "confirm_projects_connectors_confirmations_post" | "create_project_projects_post" | "decide_workflow_human_task_projects_workflows_human_tasks__human_task_id__decide_post" | "delete_project_projects_delete_post" | "evaluate_intent_policy_projects_intent_policy_evaluations_post" | "health_healthz_get" | "inspect_projects_connectors_inspect_post" | "latest_commit_projects_imports_commit_latest_post" | "list_operations_runtime_operations_get" | "manifest_members_projects_imports_manifest_members_post" | "manifest_projects_imports_manifest_post" | "open_project_projects_open_post" | "operation_events_runtime_operations__operation_id__events_get" | "operation_status_runtime_operations__operation_id__get" | "prepare_commit_projects_imports_commit_prepare_post" | "preview_intent_projects_intent_preview_post" | "preview_project_cache_projects_privacy_cache_preview_post" | "preview_projects_connectors_previews_post" | "preview_recalculation_projects_recalculation_preview_post" | "preview_status_projects_imports_status_post" | "previews_projects_imports_list_post" | "project_intent_projects_intent_post" | "project_model_catalog_projects_models_post" | "project_privacy_projects_privacy_post" | "project_workflow_progress_projects_workflow_progress_post" | "provenance_lineage_projects_provenance_lineage_post" | "readiness_readyz_get" | "recent_projects_connectors_recent_post" | "refresh_model_catalog_projects_models_refresh_post" | "registered_modules_runtime_modules_get" | "request_recalculation_restore_review_projects_recalculation_restore_reviews_post" | "restore_project_projects_restore_post" | "restore_recalculation_revision_projects_recalculation_restorations_post" | "retry_workflow_job_projects_workflows_jobs__job_id__retry_post" | "review_detail_projects_imports_detail_post" | "review_edit_projects_imports_edit_post" | "review_mapping_projects_imports_mapping_post" | "review_page_projects_imports_records_post" | "review_report_projects_imports_report_post" | "review_summary_projects_imports_review_post" | "review_undo_projects_imports_undo_post" | "save_intent_draft_projects_intent_drafts_post" | "schedule_recalculation_projects_recalculation_schedules_post" | "status_projects_connectors_jobs_status_post" | "summary_cancel_projects_imports_summary_cancel_post" | "summary_groups_projects_imports_summary_groups_post" | "summary_members_projects_imports_summary_members_post" | "summary_start_projects_imports_summary_start_post" | "summary_status_projects_imports_summary_post" | "update_project_privacy_projects_privacy_update_post" | "version_runtime_version_get" | "workflow_profile_catalog_workflow_profiles_catalog_get" | "workflow_task_center_projects_workflows_task_center_get";
...
export interface CitationQuery {
  readonly direction: "citations" | "references";
  readonly kind: "citations";
  readonly seed: ProviderIdentifier;
}

export interface ColumnSelection {
  readonly index: FieldIndex;
  readonly target: MappedName;
}
...
export interface ConnectorCapabilities {
  ...
  readonly identifierSchemes: ReadonlyArray<ProviderId>;
  readonly maximumPageSize: number;
  readonly operations: ReadonlyArray<Operation>;
  readonly providerId: ProviderId;
  readonly requiredSettings: ReadonlyArray<"contact" | "provider-key">;
  readonly schemaVersion: "1.0";
  readonly sourceApiVersion: ApiVersion | null;
}

export interface ConnectorCapabilitiesPage {
  readonly items: ReadonlyArray<ConnectorCapabilities>;
}

export interface ConnectorConfirmationRequest {
  readonly confirmation: string;
  readonly previewId: InvocationId;
  readonly root: string;
}
...
export interface ConnectorCursor {
  ...
  readonly providerId: ProviderId;
  readonly requestSha256: RequestDigest;
  readonly value: IdentifierValue;
}

export interface ConnectorInspection {
  readonly job: ConnectorRunSummary;
  readonly nextRecordOffset: number | null;
  readonly observation: ConnectorObservationSummary | null;
  readonly queryJson: string;
  readonly recordOffset: number;
  readonly scientificRequestSha256: RequestDigest;
}

export interface ConnectorInspectionRequest {
  readonly previewId: InvocationId;
  readonly recordOffset: number;
  readonly root: string;
}
...
export interface ConnectorJobStatus {
  ...
  readonly workflowRunId: InvocationId;
}

export interface ConnectorObservationSummary {
  readonly continuation: "exhausted" | "next-page" | "retry-current" | "unavailable";
  readonly fieldProjection: "title-oa-locations-discovery";
  readonly observationId: InvocationId;
  readonly observedAt: UtcInstant;
  readonly outcome: "complete" | "partial" | "failed";
  readonly recordCount: number;
  readonly records: ReadonlyArray<ConnectorRecord>;
  readonly retrievedAt: UtcInstant | null;
}

export interface ConnectorPolicy {
  readonly cacheMode: "bypass" | "revalidate" | "allow-fresh";
  readonly maxInflight: number;
  readonly maximumAttempts: number;
  readonly maximumFreshAgeMs: number;
  readonly maximumResponseBytes: number;
  readonly maximumRetryAfterMs: RetryAfter;
  readonly minimumIntervalMs: number;
  readonly rawRetention: "if-permitted" | "permitted-fields-only" | "do-not-retain";
...
export interface ConnectorPreview {
  ...
  readonly intentRevisionId: InvocationId;
  readonly intentSha256: RequestDigest;
  readonly policySha256: RequestDigest;
  readonly previewId: InvocationId;
  readonly request: ConnectorRequest;
  readonly requestSha256: RequestDigest;
  readonly retention: ConnectorRetention;
...
export interface ConnectorProjectRequest {
  readonly root: string;
}

export interface ConnectorRecentRuns {
  readonly items: ReadonlyArray<ConnectorRunSummary>;
  readonly scope: "latest-20-source-jobs-within-100-workflows";
}

export interface ConnectorRecord {
  readonly fields: ReadonlyArray<SourceField>;
  readonly identifiers: ReadonlyArray<ProviderIdentifier>;
  readonly providerId: ProviderId;
  readonly rawIdentifier: ProviderIdentifier;
...
export interface ConnectorRequest {
  ...
  readonly projectId: ProjectId;
  readonly providerId: ProviderId;
  readonly query: ScientificQuery;
  readonly schemaVersion: "1.0";
  readonly sourceApiVersion: ApiVersion | null;
}

export interface ConnectorRetention {
  readonly permittedFields: ReadonlyArray<string>;
  readonly retainBody: boolean;
  readonly rights: ImportRights;
}
...
export interface DeletionDisclosure {
  readonly canonicalProjectDataExcluded: true;
  readonly disclosureVersion: "secure-deletion-disclosure-v1";
  readonly limitations: ReadonlyArray<string>;
  readonly logicalRemoval: true;
  readonly physicalErasureGuaranteed: false;
  readonly scope: "project-cache-only";
}

export interface DiagnosticPage {
  readonly complete: boolean;
  readonly csv: string;
  readonly nextAfter: Cursor;
...
export interface ImportAddress {
  readonly previewId: Identity;
  readonly root: string;
}

export interface ImportCommitCancelRequest {
  readonly jobId: Identity;
  readonly previewId: Identity;
  readonly requestId: Identity;
  readonly root: string;
}

export interface ImportCommitPrepareRequest {
  readonly previewId: Identity;
  readonly previousManifestRevisionId: Identity | null;
  readonly revision: Revision;
  readonly root: string;
}
...
export interface ImportCommitStartRequest {
  readonly previewId: Identity;
  readonly previousManifestRevisionId: Identity | null;
  readonly requestId: Identity;
  readonly revision: Revision;
...
export interface ImportCommitStatus {
  readonly diagnosticCode: string | null;
  readonly jobId: Identity | null;
  readonly jobState: "runnable" | "claimed" | "running" | "retry-scheduled" | "cancelling" | "cancelled" | "failed" | "succeeded" | null;
  readonly manifest: ImportManifestView | null;
  readonly previewId: Identity;
  readonly requestId: Identity;
}
...
export interface ImportDuplicateGroup {
  readonly firstOrdinal: Ordinal;
  readonly groupKey: Digest;
  readonly memberCount: number;
}

export interface ImportDuplicateGroups {
  readonly complete: boolean;
  readonly groups: ReadonlyArray<ImportDuplicateGroup>;
  readonly nextAfter: Digest | null;
  readonly previewId: Identity;
  readonly reason: DuplicateReason;
  readonly revision: Revision;
}

export interface ImportDuplicateGroupsRequest {
...
export interface ImportDuplicateMembers {
  readonly complete: boolean;
  readonly groupKey: Digest;
  readonly nextAfter: Cursor;
  readonly previewId: Identity;
  readonly reason: DuplicateReason;
  readonly records: ReadonlyArray<RecordSummary>;
  readonly revision: Revision;
}

export interface ImportDuplicateMembersRequest {
...
export interface ImportGroupRequest {
  readonly corrections: ReadonlyArray<FieldCorrection>;
  readonly expectedRevision: MutationRevision;
  readonly included: boolean | null;
  readonly previewId: Identity;
  readonly records: ReadonlyArray<RecordSelection>;
  readonly root: string;
}
...
export interface ImportManifestPage {
  ...
  readonly nextAfter: Cursor;
  readonly previewId: Identity;
  readonly records: ReadonlyArray<ImportManifestRecord>;
  readonly revisionId: Identity;
}

export interface ImportManifestPageRequest {
  readonly after: Cursor;
  readonly limit: PageLimit;
  readonly previewId: Identity;
  readonly revisionId: Identity;
...
export interface ImportManifestRecord {
  readonly comparison: "not-compared" | "added" | "unchanged" | "updated" | "ambiguous";
  readonly included: boolean;
  readonly ordinal: Ordinal;
  readonly previousRecordRevisionId: Identity | null;
  readonly recordKey: Digest;
  readonly sourceRecordRevisionId: Identity | null;
  readonly warnings: ReadonlyArray<string>;
}

export interface ImportManifestRequest {
  readonly previewId: Identity;
  readonly revisionId: Identity | null;
  readonly root: string;
}
...
export interface ImportManifestView {
  ...
  readonly effectiveDraftSha256: Digest;
  readonly identitySha256: Digest;
  readonly mappingId: Identity;
  readonly mappingRevision: Revision;
  readonly membersSha256: Digest;
  ...
  readonly sourceSha256: Digest;
}

export interface ImportMappingRequest {
  readonly columns: ReadonlyArray<ColumnSelection>;
  readonly expectedRevision: MutationRevision;
  readonly mode: "automatic" | "columns";
  readonly previewId: Identity;
  readonly root: string;
}

export interface ImportOptions {
  readonly duplicatePolicy: "review";
  readonly malformedPolicy: "exclude-and-report";
}
...
export interface ImportPermission {
  readonly basis: "not-reported" | "researcher-confirmed";
  readonly value: "permitted" | "denied" | "unknown";
}
...
export interface ImportPreviewItem {
  ...
  readonly formatName: "ris" | "bibtex" | "csl-json" | "doi-list" | "csv";
  readonly jobId: Identity | null;
  readonly jobState: "runnable" | "claimed" | "running" | "retry-scheduled" | "cancelling" | "cancelled" | "failed" | "succeeded" | null;
  readonly previewId: Identity;
  readonly sourceName: string;
  readonly state: "created" | "source-sealed" | "parse-started" | "parse-completed" | "draft-revised" | "cancelled" | "failed" | "security-interrupted";
}

export interface ImportPreviewPage {
  readonly complete: boolean;
  readonly items: ReadonlyArray<ImportPreviewItem>;
  readonly nextAfter: Identity | null;
}

export interface ImportRights {
  readonly derive: ImportPermission;
  readonly export: ImportPermission;
  readonly index: ImportPermission;
  readonly inspect: ImportPermission;
  readonly "model-use": ImportPermission;
  readonly quote: ImportPermission;
  readonly share: ImportPermission;
  readonly store: ImportPermission;
}

export interface ImportSummaryCancelRequest {
  readonly jobId: Identity;
  readonly previewId: Identity;
  readonly revision: Revision;
  readonly root: string;
...
export interface ImportSummaryRequest {
  readonly previewId: Identity;
  readonly revision: Revision;
  readonly root: string;
}

export interface ImportSummaryStatus {
  readonly algorithm: "draft-summary/1";
  readonly counts: SummaryCounts | null;
  readonly diagnosticCode: string | null;
  readonly jobId: Identity | null;
  readonly jobState: "runnable" | "claimed" | "running" | "retry-scheduled" | "cancelling" | "cancelled" | "failed" | "succeeded" | null;
  readonly previewId: Identity;
...
export interface IntentDraftRequest {
  readonly autonomyLevel: "human-only" | "suggest" | "prepare-reversible" | "execute-reversible";
  readonly contributionIntent: string;
  readonly egressPolicy?: IntentEgressPolicy | null;
  readonly endYear: number | null;
  readonly evidenceTypes: ReadonlyArray<"empirical-study" | "systematic-review" | "theoretical-work" | "technical-evaluation" | "standard" | "dataset" | "interpretive-text" | "stakeholder-account" | "critical-analysis" | "private-report">;
  readonly expectedRevision: number;
...
export interface IntentEgressPolicy {
  readonly approvedDestinationIds: ReadonlyArray<string>;
  readonly mode: "local-only" | "approved-redacted" | "approved-content";
}
...
export interface IntentImpactPreview {
  ...
  readonly allToolsAccessible: true;
  readonly autonomyDefaultEffects: ReadonlyArray<string>;
  readonly changeCategories: ReadonlyArray<"primary-use-case" | "corpus-scope" | "novelty-scope" | "egress-policy">;
  readonly evidenceRequirementsUnchanged: true;
  readonly expectedRevision: number;
  readonly provenanceRequirementsUnchanged: true;
  readonly schemaVersion: string;
...
export type MappedName = "title" | "doi" | "year" | "author" | "container";

export type ModelAccelerator = "none" | "gpu";

export interface ModelCatalogEntry {
  readonly availability: "ready" | "unavailable" | "unknown" | "stale";
  readonly eligibility: "not-evaluated";
  readonly manifest: ModelManifest;
  readonly manifestHash: RegistryHash;
  readonly qualifiedTaskKinds: ReadonlyArray<ModelTaskKind>;
  readonly reasonCodes: ReadonlyArray<RegistryCode>;
}

export interface ModelCatalogProjection {
  readonly catalogHash: RegistryHash | null;
  readonly entries: ReadonlyArray<ModelCatalogEntry>;
  readonly executionAvailable: false;
  readonly history: ReadonlyArray<ModelCatalogSummary>;
  readonly inventoryState: "not-configured" | "available" | "unavailable";
  readonly latestRevision: RegistryRevision;
  readonly modelCount: number;
  readonly nextHistoryRevision: RegistryRevision | null;
  readonly nextManifestId: RegistryCode | null;
  readonly projectId: string;
  readonly revision: RegistryRevision;
  readonly schemaVersion: "1.0";
}

export interface ModelCatalogReadRequest {
  readonly afterManifestId: RegistryCode | null;
  readonly beforeHistoryRevision: number | null;
...
export interface ModelCatalogSummary {
  readonly catalogHash: RegistryHash;
  readonly modelCount: number;
  readonly occurredAt: RegistryTimestamp;
  readonly previousHash: RegistryHash | null;
  readonly recordHash: RegistryHash;
  readonly revision: RegistryRevision;
}

export type ModelCost = number;

export type ModelDeployment = "local" | "remote" | "institutional";

export interface ModelExecutionIdentity {
  readonly configurationHash: RegistryHash;
  readonly evaluationId: RegistryCode | null;
  readonly evaluationVersion: RegistryVersion | null;
  readonly modelId: RegistryCode;
  readonly modelVersion: string;
  readonly providerId: RegistryCode;
  readonly providerVersion: RegistryVersion;
  readonly runtimeId: RegistryCode;
  readonly runtimeVersion: RegistryVersion;
}

export interface ModelManifest {
  readonly accelerator: ModelAccelerator;
  readonly allowedDataClasses: ReadonlyArray<RegistryDataClass>;
  readonly capabilities: ReadonlyArray<ModelTaskKind>;
  readonly contextTokens: number;
  readonly costMicrounitsPerThousandTokens: ModelCost | null;
  readonly declaredAvailability: "available" | "unavailable" | "unknown";
  readonly deployment: ModelDeployment;
  readonly features: ReadonlyArray<RegistryCode>;
  readonly identity: ModelExecutionIdentity;
  readonly licenseId: RegistryCode;
  readonly manifestId: RegistryCode;
  readonly maxOutputTokens: number;
  readonly minimumMemoryMiB: number;
  readonly modalities: ReadonlyArray<ModelModality>;
  readonly platforms: ReadonlyArray<ModelPlatform>;
  readonly qualityTier: "unrated" | "economy" | "balanced" | "quality";
...
export type ModelPlatform = "windows-x64" | "macos-arm64" | "linux-x64" | "linux-arm64";

export type ModelTaskKind = "embedding" | "reranking" | "classification" | "nli" | "structured-extraction" | "generation" | "moderation" | "tool-call";
...
export type MutationRevision = number;

export interface OaQuery {
  readonly identifier: ProviderIdentifier;
  readonly kind: "oa-resolution";
}

export type Operation = "search" | "lookup" | "citations" | "recommendations" | "oa-resolution";
...
export interface RecalculationPreview {
  ...
  readonly deferPreservesStaleVisibility: true;
...
export interface RecommendationQuery {
  ...
  readonly negativeSeeds: ReadonlyArray<ProviderIdentifier>;
  readonly positiveSeeds: ReadonlyArray<ProviderIdentifier>;
}
...
export interface RecordSummary {
  readonly doi: ShortValue | null;
  readonly fieldCount: number;
  readonly included: boolean;
  readonly kind: "record" | "header" | "directive";
  readonly ordinal: Ordinal;
  readonly recordKey: Digest;
  readonly status: "parsed" | "malformed";
  readonly title: ShortValue | null;
  readonly warnings: ReadonlyArray<WarningCode>;
}

export type RegistryCode = string;

export type RegistryDataClass = "public" | "internal" | "confidential" | "restricted";

export type RegistryHash = string;

export type RegistryRevision = number;

export type RegistryTimestamp = string;
...
export interface ReviewField {
  ...
  readonly origin: "raw" | "candidate" | "mapping" | "correction";
  readonly sourceFieldIndex: FieldIndex | null;
  readonly target: MappedName | null;
...
export interface ReviewSummary {
  readonly attemptId: Identity;
  readonly delimiter: CsvDelimiter;
  readonly mappingHighWater: Revision;
  readonly mappingId: Identity;
  readonly mappingMode: "automatic" | "columns";
  readonly mappingRevision: Revision;
  readonly options: ImportOptions;
  readonly predecessorRevision: Revision | null;
  readonly previewId: Identity;
  readonly recordCount: Cursor;
  readonly revision: Revision;
  readonly rights: ImportRights;
  readonly undoTargetRevision: Revision | null;
}
...
export type ScientificQuery = SearchQuery | LookupQuery | CitationQuery | RecommendationQuery | OaQuery;

export interface SearchFilter {
  readonly field: "publication-year" | "author-id" | "source-id" | "work-type" | "language" | "open-access";
  readonly operator: "eq" | "gte" | "lte";
  readonly value: IdentifierValue;
}

export interface SearchQuery {
  readonly field: "any" | "title" | "abstract";
  readonly fields: ReadonlyArray<"title" | "authors" | "date" | "venue" | "identifiers" | "abstract" | "references" | "rights">;
...
export interface SearchSort {
  ...
  readonly field: "relevance" | "publication-date" | "citation-count";
}

export type Section = "raw" | "candidates" | "effective";
...
export interface SourceField {
  ...
  readonly name: string;
  readonly namespace: ProviderId;
  readonly value: string;
}

export interface SourceObservation {
  readonly state: "reported" | "not-reported" | "unknown" | "not-applicable";
  readonly value: BoundedText | null;
}

export interface SourceTerms {
  readonly access: "open" | "closed" | "unknown" | "not-reported";
  readonly license: SourceObservation;
  readonly terms: SourceObservation;
}

export interface SummaryCounts {
  readonly candidateRecords: Count;
  readonly contextRows: Count;
  readonly coverage: SummaryCoverage;
  readonly doiDuplicateGroups: Count;
  readonly excludedRecords: Count;
  readonly includedRecords: Count;
  readonly malformedRows: Count;
  readonly rawDuplicateGroups: Count;
  readonly recordRows: Count;
  readonly sourceRows: Count;
  readonly warningCount: number;
  readonly warningRows: Count;
}

export interface SummaryCoverage {
  readonly author: Count;
  readonly container: Count;
  readonly doi: Count;
...
export interface WorkflowProfileCatalogProjection {
  ...
  readonly intentGuidanceVersion: "1.0.0";
  readonly profileCatalogHash: string;
  readonly profileCatalogVersion: "1.0.0";
  readonly profiles: ReadonlyArray<WorkflowProfileProjection>;
  readonly provenanceRequirementsUnchanged: true;
  readonly referenceId: "RO-UI-ACADEMIC-MINIMAL-1.5";
  readonly referenceVersion: "1.5";
...
export interface WorkflowProgressCommand {
  readonly action: "start" | "complete" | "mark-attention" | "block" | "skip" | "resume" | "revisit" | "open-supporting";
  readonly completionEvidenceRevisionIds: ReadonlyArray<string>;
  readonly expectedSelectionRevisionContentHash: string;
  ...
  readonly root: string;
  readonly stageKey: string;
  readonly supportingPageContractId: string | null;
}
...
export interface WorkflowProgressProjection {
  ...
  readonly checkpointRationale: string;
  readonly checkpointState: "unknown" | "optional-human" | "required-human" | "not-applicable";
  readonly current: WorkflowStageStateProjection | null;
  readonly history: ReadonlyArray<WorkflowStageStateProjection>;
  ...
  readonly recommendedPageContractId: string;
  readonly recommendedStageKey: string;
  readonly schemaVersion: string;
  readonly selectionRevisionContentHash: string;
  readonly selectionRevisionId: string;
  readonly staleOutputs: ReadonlyArray<WorkflowStaleOutputProjection>;
  readonly supportingHandoff: WorkflowSupportingHandoffProjection | null;
}
...
export interface WorkflowStageStateProjection {
  readonly attentionReason: string | null;
  readonly completionEvidenceIds: ReadonlyArray<string>;
  readonly navigationRole: "primary" | "supporting";
  readonly pageContractId: string;
  readonly parentStateRevisionId: string | null;
  readonly passNumber: number;
  readonly revision: number;
  readonly revisionContentHash: string;
  readonly skipRationale: string | null;
  readonly stageKey: string;
  readonly stageStateId: string;
  readonly stageStateRevisionId: string;
  readonly staleCauseIds: ReadonlyArray<string>;
  readonly status: "not-started" | "available" | "current" | "in-progress" | "attention-required" | "blocked" | "completed" | "stale" | "skipped-with-rationale";
  readonly updatedAt: string;
}

export interface WorkflowStaleOutputProjection {
  readonly causeReferenceHash: string;
  readonly disposition: "stale" | "unknown-impact";
...
export interface WorkflowSupportingHandoffProjection {
  readonly navigationRole: "supporting";
  readonly pageContractId: string;
