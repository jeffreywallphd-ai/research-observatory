...
cross-process-serialized compare-and-swap replacement, callback-scoped delivery, and redacted audit
facts. It deliberately contains no operating-system path, provider SDK type,
