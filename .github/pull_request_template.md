...
- Task ID: `CAP-XX.SXX.TXX`
- Criterion evidence: `artifacts/evidence/...`
- Required verification profile(s):

## UI-reference lineage

- UI implementation changed: `no | intentional-design-change | approved-reference-implementation | defect-restoration`
- UI change contract: `artifacts/evidence/ui-change/CAP-XX.SXX.TXX.json | not applicable`
...
- Unverified items or hosted-CI residuals:
- Migration, security, accessibility, or platform impact:
