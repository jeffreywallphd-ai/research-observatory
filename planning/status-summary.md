...
| `CAP-03.S03.T01` | `append-only v1` | 1 | `R02` | changes-requested / codex-independent-provenance-contract-reviewer | `CAP-03.S03.T01-R01-F01`, `CAP-03.S03.T01-R01-F02`, `CAP-03.S03.T01-R01-F03` |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 10/15 | 32/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 2/6 | 6/20 | `CAP-03.S03.T01` |
