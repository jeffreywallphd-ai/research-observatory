...
| `CAP-03.S02.T01` | `append-only v1` | 0 | `R01` | - / - | - |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 1/6 | 3/20 | `CAP-03.S02.T01` |
