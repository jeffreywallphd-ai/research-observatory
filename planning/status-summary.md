...
- Bound exit evidence: amendment `W1.A07` / `artifacts/evidence/W1.A07.exit.json` / `a92b4bf8db9a20d181201ad7eafe9750bb4cc00c8d3ecebb24e308b88f7eddcd` / `fea1a49dd19ee41d08fdad5a2c1017f48dfac039`
- Acceptance-criteria SHA-256: `6d941185c23760c23179f113bea3b6cdbf7b03c0e1929657bf61e4c386a47888`
- Selected-check SHA-256: `57a79b85b068cc997db54a0da32d5b0d58c89876cd1268313298f2f7d40357ae`
...
| `CAP-04.S02.T01` | `append-only v1` | 1 | `-` | approved / agent:w2-s01-final-review | - |
...
| `W1.A08.T02` | `append-only v1` | 1 | `-` | approved / agent:window_launch_planning | - |
...
| `W2` - Windows local evidence foundation | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 1/11 | 6/34 | `G2` / `PENDING` |
...
| CAP-scholarly-ingestion (`CAP-04`) — Scholarly ingestion, connectors, canonicalization, and corpus governance | `NONE` | `PENDING` | 1/5 | 5/15 | `CAP-04.S02.T03` |
...
|---|---|---|---|
| `CAP-04.S02.T03` Implement Unpaywall and Semantic Scholar adapters | `IN_PROGRESS` | codex-w2-implementation | `codex/w2-implementation` |
