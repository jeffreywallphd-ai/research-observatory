...
| `CAP-03.S06.T02` | `append-only v1` | 1 | `R02` | changes-requested / agent:t02-independent-reviewer | `CAP-03.S06.T02-R01-F01`, `CAP-03.S06.T02-R01-F02`, `CAP-03.S06.T02-R01-F03` |
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 13/15 | 42/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 5/6 | 16/20 | `CAP-03.S06.T02` |
