...
source_sha256: 2bab2d87c1aab23d6f51b4fbeb89ac0197e6c9aebcfca37d68221a3d61921426
...
| `W1` - Windows local runtime and durable core | `APPROVED` | `ACTIVE` | `IN_PROGRESS` | 12/15 | 41/48 | `G1` / `PENDING` |
...
| CAP-research-domain-workflows (`CAP-03`) — Canonical domain, research intent, provenance, and durable workflows | `NONE` | `PENDING` | 4/6 | 15/20 | - |
