...
- Binding detail: Docling pinned version/model packaging and resource limits.
- Binding detail: OCR activation and degraded fallback policy.
...
2. Confirm W2 is the approved active campaign and `CAP-05.S02` is dependency-eligible.
3. Claim only the next READY task in `CAP-05.S02` through taskctl; do not bypass Wave dependencies or create a capability lease.
