...
- ADR: Rights/permitted-use vocabulary and default-unknown policy.
- ADR: Corpus snapshot/version semantics.
- ADR: Discovery path and source-overlap graph representation.
...
2. Confirm `CAP-04` is the active capability campaign and `CAP-04.S04` is the next eligible slice.
3. Claim the first READY task in order: `CAP-04.S04.T01`. Do not globally select work outside the capability.
